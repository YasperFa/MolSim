...
class ParametersType: public ::xml_schema::type
{
   ...
   *
   * @brief Accessor and modifier functions for the %parallelVersion
   * optional element.
   */
  //@{
   ...
   * @brief Element type.
   */
  typedef ::xml_schema::boolean parallelVersion_type;

  /**
   * @brief Element optional container type.
   */
  typedef ::xsd::cxx::tree::optional< parallelVersion_type > parallelVersion_optional;

  /**
   * @brief Element traits type.
   */
  typedef ::xsd::cxx::tree::traits< parallelVersion_type, char > parallelVersion_traits;
   ...
   * @return A constant reference to the optional container.
   */
  const parallelVersion_optional&
  ...
  parallelVersion_optional parallelVersion_;
