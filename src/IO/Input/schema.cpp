...
const ParametersType::parallelVersion_optional& ParametersType::
parallelVersion () const
{
  return this->parallelVersion_;
}

ParametersType::parallelVersion_optional& ParametersType::
parallelVersion ()
{
  return this->parallelVersion_;
}
...
void ParametersType::
parallelVersion (const parallelVersion_type& x)
{
  this->parallelVersion_.set (x);
}

void ParametersType::
parallelVersion (const parallelVersion_optional& x)
{
  this->parallelVersion_ = x;
}
...
: ::xml_schema::type (x, f, c),
  ...
  parallelVersion_ (x.parallelVersion_, f, this)
{
}
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    // parallelVersion
    //
    if (n.name () == "parallelVersion" && n.namespace_ ().empty ())
    {
      if (!this->parallelVersion_)
      {
        this->parallelVersion_.set (parallelVersion_traits::create (i, f, this));
        continue;
      }
    }
...
operator= (const ParametersType& x)
{
  if (this != &x)
  {
    ...
    this->parallelVersion_ = x.parallelVersion_;
  }
