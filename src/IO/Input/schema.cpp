...
{
  return this->parallelVersion2_;
}

ParametersType::parallelVersion2_optional& ParametersType::
parallelVersion2 ()
{
  return this->parallelVersion2_;
}
...
ParametersType::harmonicForce_optional& ParametersType::
harmonicForce ()
{
  return this->harmonicForce_;
}
...
const HarmonicForceType::harmonicOn_type& HarmonicForceType::
harmonicOn () const
{
  return this->harmonicOn_.get ();
}

HarmonicForceType::harmonicOn_type& HarmonicForceType::
harmonicOn ()
{
  return this->harmonicOn_.get ();
}

void HarmonicForceType::
harmonicOn (const harmonicOn_type& x)
{
  this->harmonicOn_.set (x);
}

HarmonicForceType::harmonicOn_type HarmonicForceType::
harmonicOn_default_value ()
{
  return harmonicOn_type (false);
}

const HarmonicForceType::stiffnessConstant_optional& HarmonicForceType::
stiffnessConstant () const
{
  return this->stiffnessConstant_;
}

HarmonicForceType::stiffnessConstant_optional& HarmonicForceType::
stiffnessConstant ()
{
  return this->stiffnessConstant_;
}
...
HarmonicForceType::stiffnessConstant_type HarmonicForceType::
stiffnessConstant_default_value ()
{
  return stiffnessConstant_type (.0);
}

const HarmonicForceType::avgBondLength_optional& HarmonicForceType::
avgBondLength () const
{
  return this->avgBondLength_;
}

HarmonicForceType::avgBondLength_optional& HarmonicForceType::
avgBondLength ()
{
  return this->avgBondLength_;
}
...
{
  this->avgBondLength_.set (x);
}

void HarmonicForceType::
avgBondLength (const avgBondLength_optional& x)
{
  this->avgBondLength_ = x;
}

HarmonicForceType::avgBondLength_type HarmonicForceType::
avgBondLength_default_value ()
{
  return avgBondLength_type (.0);
}
...
const SubSimulationsType::subSimulation_sequence& SubSimulationsType::
subSimulation () const
{
  return this->subSimulation_;
}

SubSimulationsType::subSimulation_sequence& SubSimulationsType::
subSimulation ()
{
  return this->subSimulation_;
}

void SubSimulationsType::
subSimulation (const subSimulation_sequence& s)
{
  this->subSimulation_ = s;
}
...
const SubSimulationType::inputFile_type& SubSimulationType::
inputFile () const
{
  return this->inputFile_.get ();
}

SubSimulationType::inputFile_type& SubSimulationType::
inputFile ()
{
  return this->inputFile_.get ();
}
...
const simulation::subSimulations_optional& simulation::
subSimulations () const
{
  return this->subSimulations_;
}

simulation::subSimulations_optional& simulation::
subSimulations ()
{
  return this->subSimulations_;
}
...
{
  this->subSimulations_.set (x);
}

void simulation::
subSimulations (const subSimulations_optional& x)
{
  this->subSimulations_ = x;
}

void simulation::
subSimulations (::std::unique_ptr< subSimulations_type > x)
{
  this->subSimulations_.set (std::move (x));
}
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    // parallelVersion2
    //
    if (n.name () == "parallelVersion2" && n.namespace_ ().empty ())
    {
      if (!this->parallelVersion2_)
      {
        this->parallelVersion2_.set (parallelVersion2_traits::create (i, f, this));
        continue;
      }
    }
    ...
    {
      ::std::unique_ptr< harmonicForce_type > r (
        harmonicForce_traits::create (i, f, this));

      if (!this->harmonicForce_)
      {
        this->harmonicForce_.set (::std::move (r));
        continue;
      }
    }
...
HarmonicForceType::
HarmonicForceType (const harmonicOn_type& harmonicOn)
: ::xml_schema::type (),
  harmonicOn_ (harmonicOn, this),
...
HarmonicForceType (const HarmonicForceType& x,
                   ...
                   ::xml_schema::container* c)
: ::xml_schema::type (x, f, c),
  harmonicOn_ (x.harmonicOn_, f, this),
  stiffnessConstant_ (x.stiffnessConstant_, f, this),
  avgBondLength_ (x.avgBondLength_, f, this)
{
}
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    // harmonicOn
    //
    if (n.name () == "harmonicOn" && n.namespace_ ().empty ())
    {
      if (!harmonicOn_.present ())
      {
        this->harmonicOn_.set (harmonicOn_traits::create (i, f, this));
        continue;
      }
    }
    ...
    {
      if (!this->avgBondLength_)
      {
        this->avgBondLength_.set (avgBondLength_traits::create (i, f, this));
        continue;
      }
    }
...
operator= (const HarmonicForceType& x)
{
  ...
  {
    static_cast< ::xml_schema::type& > (*this) = x;
    this->harmonicOn_ = x.harmonicOn_;
...
SubSimulationsType (const SubSimulationsType& x,
                    ...
                    ::xml_schema::container* c)
: ::xml_schema::type (x, f, c),
  subSimulation_ (x.subSimulation_, f, this)
{
}
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    // subSimulation
    //
    if (n.name () == "subSimulation" && n.namespace_ ().empty ())
    {
      ::std::unique_ptr< subSimulation_type > r (
        subSimulation_traits::create (i, f, this));

      this->subSimulation_.push_back (::std::move (r));
      continue;
    }
...
SubSimulationsType* SubSimulationsType::
_clone (::xml_schema::flags f,
        ::xml_schema::container* c) const
{
  return new class SubSimulationsType (*this, f, c);
}
...
operator= (const SubSimulationsType& x)
{
  ...
  {
    static_cast< ::xml_schema::type& > (*this) = x;
    this->subSimulation_ = x.subSimulation_;
  }
...
: ::xml_schema::type (x, f, c),
  ...
  subSimulations_ (x.subSimulations_, f, this)
{
}
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    // subSimulations
    //
    if (n.name () == "subSimulations" && n.namespace_ ().empty ())
    {
      ::std::unique_ptr< subSimulations_type > r (
        subSimulations_traits::create (i, f, this));

      if (!this->subSimulations_)
      {
        this->subSimulations_.set (::std::move (r));
        continue;
      }
    }
...
operator= (const simulation& x)
{
  if (this != &x)
  {
    ...
    this->subSimulations_ = x.subSimulations_;
  }
