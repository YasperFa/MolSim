...
Particle::Particle(const Particle &other) {
    ...
    neighbourParticles = other.neighbourParticles;
...
void Particle::subF(const std::array<double, 3> &newF) {
    forceMutex.lock();
    f[0] -= newF[0];
    f[1] -= newF[1];
    f[2] -= newF[2];
...
// neighbour functions
void Particle::addNeighbourParticle(long ptr_diff, double l_0, double k) {
    neighbourParticles.emplace_back(ptr_diff, l_0, k);
}

const std::vector<std::tuple<long, double, double> > &Particle::getNeighbourParticles() const {
