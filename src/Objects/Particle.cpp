...
double m_arg, int type_arg, double epsilon_arg, double sigma_arg, bool isFixed) : x(x_arg), v(v_arg), m(m_arg), type(type_arg), epsilon(epsilon_arg), sigma(sigma_arg), isFixed(isFixed){
  f = {0., 0., 0.};
  old_f = {0., 0., 0.};
  old_x = {NAN, NAN, NAN};
  id = ParticleIdInitializer::getNewId();
...
double Particle::getSigma() {return sigma;}
 ...
 void Particle::setPartner(int i, int id){
  switch (i){
    case 0: partner[0] = id; return;
    case 1: partner[0] = id; return;
    case 2: partner[1] = id; return;
    case 3: partner[1] = id; return;
    case 4: partner[2] = id; return;
    default: partner[2] = id; return;
  }
 }
