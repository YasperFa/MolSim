...
void XYZWriter::plotParticles(std::list<Particle> particles,
  ...
  SPDLOG_TRACE("XYZ Writer plotParticles: opening file in iteration {}", iteration);
  std::ofstream file;
  ...
  file << "Generated by MolSim. See http://openbabel.org/wiki/XYZ_(format) for "
          "file format doku."
       << std::endl;
SPDLOG_TRACE("XYZ Writer plotParticles: plotting particles in iteration {}", iteration);
